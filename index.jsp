		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a class="page-scroll" href="#about">Inscription</a></li>
					<li><a class="page-scroll" href="#services">Fonctionnalités</a>
					</li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
	...
	<header>
		<div class="header-content">
			<div class="header-content-inner">
				...
				<!-- <a href="#about" class="btn btn-primary btn-xl page-scroll">//  Barre de recherche  // -->
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 text-center">
					...
					<a href="#services"
						class="page-scroll btn btn-default btn-xl sr-button">Inscrivez-vous!</a>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row no-gutter popup-gallery">
				<div class="col-lg-4 col-sm-4">
					<a href="img/portfolio/fullsize/01.jpg" class="portfolio-box">
						<img src="img/portfolio/thumbnails/01.jpg" class="img-responsive"
						alt="">
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">Fonctionnalités</div>
								<div class="project-name">Infos Pays</div>
							</div>
						</div>
					</a>
				</div>
				<div class="col-lg-4 col-sm-4">
					<a href="img/portfolio/fullsize/02.jpg" class="portfolio-box">
						<img src="img/portfolio/thumbnails/02.jpg" class="img-responsive"
						alt="">
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">Fonctionnalités</div>
								<div class="project-name">Journal</div>
							</div>
						</div>
					</a>
				</div>
				<div class="col-lg-4 col-sm-4">
					<a href="img/portfolio/fullsize/03.jpg" class="portfolio-box">
						<img src="img/portfolio/thumbnails/03.jpg" class="img-responsive"
						alt="">
						<div class="portfolio-box-caption">
							<div class="portfolio-box-caption-content">
								<div class="project-category text-faded">Fonctionnalités</div>
								<div class="project-name">Valise</div>
							</div>
						</div>
					</a>
				</div>
